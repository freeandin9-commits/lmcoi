  ...
  return (
    <Shell>
      ...
      <div className="px-4 pt-4 space-y-5 pb-8 relative z-10">
        ...
        {/* MENU LIST - Glassmorphism (Updated with requested changes) */}
        <div className="animate-glass-3 rounded-3xl overflow-hidden backdrop-blur-2xl bg-background/40 dark:bg-black/30 border border-white/20 dark:border-white/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.1)] transition-all duration-500">
          {[
            ...
            { icon: Landmark, label: "Bank Accounts", path: "/bank-accounts" }, // <-- New Feature
            ...
            { icon: UserPlus, label: "Invite Friends", path: "/invite" }, // <-- New Feature
            { icon: HelpCircle, label: "Help & Support", path: "/support" },
            { icon: Globe, label: "Language", path: "/language" }, // <-- New Feature
            { icon: Moon, label: "Display & Theme", path: "/theme" }, // <-- New Feature
